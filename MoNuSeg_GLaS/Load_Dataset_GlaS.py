...
class ImageToImage2D_GLaS(Dataset):
    """
    ...
    def __init__(self, dataset_path: str, joint_transform: Callable = None, 
                 filelists = None, one_hot_mask: int = False,  task_name = None, split = 'train',
